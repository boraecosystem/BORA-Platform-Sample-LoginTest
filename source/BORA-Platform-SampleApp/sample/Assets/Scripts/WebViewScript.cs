...
public class WebViewScript : MonoBehaviour
{
    ...
    const string authServer = "https://auth.boraecosystem.com";
    const string authPath = "/v1/oauth/authorize";      // request authorized code

    const string sampleServer = "http://dev-auth-sample-web.boraecosystem.com";
    ...
    // const string loginUrl = "https://accounts.boraecosystem.com/member/login";
